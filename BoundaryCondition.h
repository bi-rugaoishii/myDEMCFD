...
struct BoundaryCondition{
    ...
    void set_bctype(int bid, BoundaryType Type);
    void set_boundary_velocity(int bid, double vx, double vy, double vz);

};

inline void BoundaryCondition::set_bctype(int bid, BoundaryType Type){
    bcType_(bid)=Type;
}

inline void BoundaryCondition::set_boundary_velocity(int bid, double vx, double vy, double vz){
    vx_(bid)=vx;
    vy_(bid)=vy;
    vz_(bid)=vz;
}
